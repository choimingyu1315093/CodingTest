package com.choimingyu.hicarenettest.view.fragment;
 ...
 */
public abstract class Hilt_FirstFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FirstFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FirstFragment_GeneratedInjector) this.generatedComponent()).injectFirstFragment(UnsafeCasts.<FirstFragment>unsafeCast(this));
    }
  }
